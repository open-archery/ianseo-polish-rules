...
class PLDiplomaPdf extends TCPDF
{
     ...
     */
    public function printDiploma($competitionName, $dates, $location, $classText, $rank, $athleteName, $clubName, $teamMembers = [], $bodyText = '', $headJudge = '', $organizer = ''): void
    {
        $this->AddPage();
        ...
        // Signature lines
        $lineStyle = ['width' => 0.3, 'color' => [0, 0, 0]];
        $lineLen = 60;
