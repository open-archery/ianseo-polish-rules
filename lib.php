...
// ---------------------------------------------------------------------------
function CreateStandardDivisions($TourId, $TourType): void
{
    $i = 1;
...
// ---------------------------------------------------------------------------
function CreateStandardClasses($TourId, $TourType): void
{
    $i      = 1;
    $hasU15 = in_array($TourType, [3, 6], true);
    $hasU12 = ($TourType === 6);
...
// ---------------------------------------------------------------------------
function InsertStandardEvents($TourId, $TourType): void
{
    ...
    $rMixedAges = ['', 'U24', 'U21', 'U18', '50'];
    $cMixedAges = ['', 'U21', 'U18', '50'];
    $bMixedAges = ['', 'U21', 'U18'];
    if (in_array($TourType, [3, 6], true)) {
        $rMixedAges[] = 'U15';
        $cMixedAges[] = 'U15';
